...
class GStreamerTilingApp(GStreamerApp):
    def __init__(self, app_callback, user_data, parser=None):
        ...
        parser.add_argument("--overlap_x_axis", default=0.1, help="Set overlap in percentage between tiles along x axis (columns). Default is 0.1 (10%%)")
        parser.add_argument("--overlap_y_axis", default=0.1, help="Set overlap in percentage between tiles along y axis (rows). Default is 0.1 (10%%)")
